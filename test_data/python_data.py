...
analytics = 'аналитику: когда зарегистрировалась  в системе цеха1, сколько времени и по какому маршруту проходила, были ли отклонения от заданного графика, когда покинула локацию цеха1 и время попадания в цех 2 и та же инфо что по цеху1'